...
cell_t cell_table[CELL_MAX] = {
    ...
    //{ .t=Event_T,       .x=566,         .y=NIL,         .z=NIL          },  // <--- START = (G_TEST)
...
#define REPL_F (A_BOOT+17)
    ...
    { .t=VM_push,       .x=REPL_E,      .y=569,         .z=UNDEF        },  // ok = REPL_E  --> {k:G_EVAL_X}
