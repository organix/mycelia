...
//"; Ofs = immediate\n"
"($define! arm-ls-imm\n"
"  ($lambda (imm) (bit-or (bit-and imm #xfff) #x0200_0000)))\n"
//"; Ofs = register\n"
"($define! arm-ls-Rm ($lambda (m) (bit-and m #xf)))\n"
"($define! arm-ls-Regs\n"
"  ($lambda (r)\n"
"    ($if (pair? r)\n"
"      (($lambda (a . d)\n"
"        (bit-or (bit-lsl 1 a) (arm-ls-Regs d))) r)\n"
"      0)))\n"
//"($define! arm-stmda\n"
//"  ($lambda (n . r) (bit-or #xe800_0000 (arm-ls-Rn n) (arm-ls-Regs r)) ))\n"
//"($define! arm-ldmda\n"
//"  ($lambda (n . r) (bit-or #xe810_0000 (arm-ls-Rn n) (arm-ls-Regs r)) ))\n"
//"($define! arm-stmdb\n"
//"  ($lambda (n . r) (bit-or #xe900_0000 (arm-ls-Rn n) (arm-ls-Regs r)) ))\n"
//"($define! arm-ldmdb\n"
//"  ($lambda (n . r) (bit-or #xe910_0000 (arm-ls-Rn n) (arm-ls-Regs r)) ))\n"
"($define! arm-stmia\n"
"  ($lambda (n . r) (bit-or #xe880_0000 (arm-ls-Rn n) (arm-ls-Regs r)) ))\n"
"($define! arm-ldmia\n"
"  ($lambda (n . r) (bit-or #xe890_0000 (arm-ls-Rn n) (arm-ls-Regs r)) ))\n"
"($define! arm-stmib\n"
"  ($lambda (n . r) (bit-or #xe980_0000 (arm-ls-Rn n) (arm-ls-Regs r)) ))\n"
"($define! arm-ldmib\n"
"  ($lambda (n . r) (bit-or #xe990_0000 (arm-ls-Rn n) (arm-ls-Regs r)) ))\n"
//"($define! arm-stmda-wb\n"
//"  ($lambda (n . r) (bit-or #xe820_0000 (arm-ls-Rn n) (arm-ls-Regs r)) ))\n"
//"($define! arm-ldmda-wb\n"
//"  ($lambda (n . r) (bit-or #xe830_0000 (arm-ls-Rn n) (arm-ls-Regs r)) ))\n"
"($define! arm-stmdb-wb\n"
"  ($lambda (n . r) (bit-or #xe920_0000 (arm-ls-Rn n) (arm-ls-Regs r)) ))\n"
"($define! arm-ldmdb-wb\n"
"  ($lambda (n . r) (bit-or #xe930_0000 (arm-ls-Rn n) (arm-ls-Regs r)) ))\n"
"($define! arm-stmia-wb\n"
"  ($lambda (n . r) (bit-or #xe8a0_0000 (arm-ls-Rn n) (arm-ls-Regs r)) ))\n"
"($define! arm-ldmia-wb\n"
"  ($lambda (n . r) (bit-or #xe8b0_0000 (arm-ls-Rn n) (arm-ls-Regs r)) ))\n"
//"($define! arm-stmib-wb\n"
//"  ($lambda (n . r) (bit-or #xe9a0_0000 (arm-ls-Rn n) (arm-ls-Regs r)) ))\n"
//"($define! arm-ldmib-wb\n"
//"  ($lambda (n . r) (bit-or #xe9b0_0000 (arm-ls-Rn n) (arm-ls-Regs r)) ))\n"
#endif
"\n";
